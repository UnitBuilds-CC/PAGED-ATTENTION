...
cover_image: "https://dev-to-uploads.s3.us-east-2.amazonaws.com/uploads/articles/ws6akojjc2uxxr2n4cax.jpeg"
---
...
{% card %}
### ⚠️ How it affects LLMs
Even if you have 10 GB of total free VRAM, if it is split into 100 scattered megabyte-sized gaps, a new incoming request requiring a contiguous 1 GB block will fail—triggering a CUDA OOM crash because the allocator cannot defragment VRAM dynamically.
{% endcard %}
...
{% details Click to see the Page Split Javascript logic %}
```javascript
